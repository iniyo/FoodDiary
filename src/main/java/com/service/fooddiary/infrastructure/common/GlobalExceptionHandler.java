package com.service.fooddiary.infrastructure.common;
...
import com.service.fooddiary.domain.common.exception.domain.BusinessBaseException;
...
class GlobalExceptionHandler {
    ...
    /**
     * 사용자 정의 입력 데이터 검증 실패 예외 처리
     *
     * @param e InputValidationException
     * @return 에러 응답 및 HTTP 상태 코드
     */
    @ExceptionHandler(InputValidationException.class)
    protected ResponseEntity<ErrorResponse> handleInputValidationException(InputValidationException e) {
        log.warn("InputValidationException 발생: {}", e.getMessage());
